...
public class SetOfNaturalsTest {
    ...
    //Tests added:
    //testAddIllegal:See that it trows an invalid argument exception if a value already in array is added
    //testAddIllegalArray:See that it trows an invalid argument exception if trying to add a array with duplicates
    ...
    @Test
    public void testAddIllegalArray(){
        int[] invalidArray = {10, 20 , 25, 35};
        assertThrows(IllegalArgumentException.class, () -> setD.add(invalidArray));
    }
