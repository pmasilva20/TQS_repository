...
public class Dip {
    ...
    static final int STAR_COUNT = 2;
    static final int NUMBER_COUNT = 5;
    static final int NUMBER_RANGE = 50;
    static final int STAR_RANGE = 10;
    private SetOfNaturals numbers;
    private SetOfNaturals starts;
    private static SecureRandom generator = new SecureRandom(); // Compliant for security-sensitive use cases
    ...
    public Dip(int[] arrayOfNumbers, int[] arrayOfStarts) {
        ...
        if (NUMBER_COUNT == arrayOfNumbers.length && STAR_COUNT == arrayOfStarts.length) {
